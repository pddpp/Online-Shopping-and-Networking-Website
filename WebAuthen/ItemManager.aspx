<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ItemManager.aspx.cs" Inherits="WebAuthen_ShoppingCart" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:GridView runat="server" ID="ShoppingCart" PageSize="5" Width="800px" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <asp:BoundField DataField="Interest" HeaderText="Interested Buyers" SortExpression="InterestedBuyers" />    
            ...
            <asp:TemplateField ShowHeader="false">
                <ItemTemplate>
                    ...
                    <asp:Button ID="DeleteFromCart" CommandName="DeleteItem" style="background-color:#2dbd54; color:#fff;border:none" CommandArgument='<%# Eval("Id") %>' Text="Remove Item" runat="server"></asp:Button>
                    </div>
                        </ItemTemplate>
            </asp:TemplateField>
        </Columns>
